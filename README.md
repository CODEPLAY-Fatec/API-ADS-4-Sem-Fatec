...
| :--: | :--------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------: | :----: | :-------------------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  1   |    Alta    | **Como usuário, quero cadastrar projetos para gerenciar eficientemente os projetos da FAPG, para que a organização e o acompanhamento sejam assertivos.**                                                           |     5      |   1    |          RF1          | - Formulário com campos obrigatórios (nome, descrição, data, etc.)<br>- Mensagem de sucesso ao salvar<br>- Persistência dos dados no banco e disponibilidade nas consultas futuras                                                                        |
